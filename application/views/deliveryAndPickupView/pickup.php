        ...
        <div class="">
            <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                <thead class="thead-dark">
                    ...
                    <th class="th-sm">Pickup Date <i class="fa fa-sort">
                    </th>
                    <th class="th-sm">Pickup Time <i class="fa fa-sort">
                    </th>
                ...
                <tbody>
                    ...
                    <td><?php echo $customerList->date ?></td>
                    <td><?php echo $customerList->time ?></td>
                    <td>
